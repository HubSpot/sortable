(function () {
    ...
    sortable = {
        ...
        sort: function (table) {
            ...
            var compare, position, row, rowArray, tBody, value, _compare, _i, _j, _k, _len1, _len2, _ref;
            var ths, type, sortedDirection, cellIndex;
            ...
            for (i = _i = 0, _len = ths.length; _i < _len; i = ++_i) {
                ...
                if (th.getAttribute('data-sorted') === 'true') {
                    ...
                    sortedDirection = th.getAttribute('data-sorted-direction');
                    cellIndex = i;
                }
            }
            ...
            for (position = _j = 0, _len1 = _ref.length; _j < _len1; position = ++_j) {
                row = _ref[position];
                value = sortable.getNodeValue(row.cells[cellIndex]);
        ...
        setupClickableTH: function (table, th, i) {
            ...
            type = sortable.getColumnType(table, i);
            onClick = function (e) {
                var newSortedDirection, sorted, sortedDirection, ths, _i, _len;
                if (e.handled !== true) {
                    e.handled = true;
                } else {
                    return false;
